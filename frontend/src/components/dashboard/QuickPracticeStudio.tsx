          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 mb-2">
                <div className="p-2 rounded-xl bg-slate-100 text-slate-800 font-bold border border-slate-200">
                  <Icon className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="text-xs font-bold text-slate-900 leading-tight">{drill.title}</h3>
                  <span className={`text-[9px] font-bold uppercase px-1.5 py-0.5 rounded mt-0.5 inline-block border ${drill.badge}`}>
                    {drill.difficulty}
                  </span>
                </div>
              </div>
